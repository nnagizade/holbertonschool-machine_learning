#!/usr/bin/env python3
"""Module for finding a snippet of text within a reference document
to answer a question, using a pretrained BERT model from tensorflow-hub.
"""
...
def question_answer(question, reference):
    ...
    Args:
        ...
        reference: a string containing the reference document from
