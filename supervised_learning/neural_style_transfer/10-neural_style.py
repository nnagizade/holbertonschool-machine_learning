...
class NST:
    ...
    def __init__(self, style_image, content_image, alpha=1e4, beta=1,
        ...
        Raises TypeError if var is not a non-negative number
        """
    ...
    def content_cost(self, content_output):
        ...
        Raises TypeError if content_output is not an instance of
        tf.Tensor or tf.Variable with the same shape as
    ...
    def total_cost(self, generated_image):
        ...
        Raises TypeError if generated_image is not an instance of
        tf.Tensor or tf.Variable with the same shape as
        self.content_image
    ...
    def compute_grads(self, generated_image):
        """
        Calculate the gradients for the generated image.
        ...
        Returns: gradients, J_total, J_content, J_style, J_var
    ...
    def generate_image(self, iterations=1000, step=None, lr=0.01,
        ...
        Gradient descent is performed using Adam optimization. The
        generated image is initialized as the content image. Keeps
        track of the best cost and the image associated with that
        cost.
