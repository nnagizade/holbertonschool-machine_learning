#!/usr/bin/env python3
"""Defines a function that calculates the symmetric P affinities."""
import numpy as np
...
def P_affinities(X, tol=1e-5, perplexity=30.0):
    ...
    perplexity: the perplexity that all Gaussian distributions should
        have
    tol: the maximum tolerance allowed (inclusive) for the difference
        in Shannon entropy from perplexity for all Gaussian
        distributions
